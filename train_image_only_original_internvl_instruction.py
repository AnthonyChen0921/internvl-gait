...
STATE_PATH = "image_only_original_internvl_instruction_state.pt"
...
def main():
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if macro_f1 > best_macro_f1:
            ...
            print(f"Saved new best original-InternVL (instruction prompt) model (macro-F1={macro_f1*100:.2f}%)")
        ...
        print(f"Saved last-epoch original-InternVL (instruction prompt) model to {STATE_PATH}")
