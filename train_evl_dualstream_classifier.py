...
CKPT_PATH = "best_evl_dualstream_classifier.pt"
STATE_PATH = "evl_dualstream_train_state.pt"
...
def main():
    ...
    for epoch in range(start_epoch, EPOCHS + 1):
        ...
        if macro_f1 > best_macro_f1:
            ...
            print(f"Saved new best EVL dual-stream model (macro-F1={macro_f1*100:.2f}%)")
